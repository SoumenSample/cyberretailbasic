...
export function PerformanceList() {
  ...
  const getRatingColor = (rating: number) => {
    ...
    if (rating >= 3.5) return "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400";
    if (rating >= 2.5) return "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400";
                      ...
                      <TableRow key={review._id}>
                        ...
                        <TableCell>
                          {review.promotionEligible ? (
                            <span className="bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400 px-2 py-1 rounded-full text-xs font-medium">
                              Eligible
                            </span>
                          ) : (
                            <span className="bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-400 px-2 py-1 rounded-full text-xs font-medium">
                              Not Eligible
                            </span>
                          )}
                        </TableCell>
