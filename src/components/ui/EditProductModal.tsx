  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Product" size="lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Product Info */}
        <div className="rounded-lg bg-slate-50 dark:bg-zinc-800/50 p-3 mb-4">
          <p className="text-sm text-slate-700 dark:text-zinc-300">
            Updating: <span className="font-medium text-slate-900 dark:text-zinc-100">{product.name}</span>
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Field label="Product name">
            <input
              ...
              className="h-11 rounded-xl border border-slate-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 px-3 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
          </Field>
          <Field label="SKU">
            <input
