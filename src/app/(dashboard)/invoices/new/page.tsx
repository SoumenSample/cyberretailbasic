...
function Field({ label, htmlFor, children }: FieldProps) {
  return (
    <label className="grid gap-2 text-sm font-medium text-slate-700 dark:text-zinc-300" htmlFor={htmlFor}>
      <span>{label}</span>
      {children}
    </label>
  );
...
export default function NewInvoicePage() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <section className="grid gap-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Field label="Document type" htmlFor="documentType">
            <select
              ...
              className="h-11 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 text-sm text-zinc-900 dark:text-zinc-100"
            >
          ...
          <div className="grid gap-2 text-sm font-medium text-slate-700 dark:text-zinc-300">
            <span>Invoice number preview</span>
            <div className="flex h-11 items-center rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 px-3 text-sm text-zinc-700 dark:text-zinc-300">
      ...
      <section className="grid gap-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field label="Buyer GSTIN" htmlFor="buyerGstin">
            <input
              ...
              placeholder="GSTIN"
              className="h-11 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 text-sm uppercase text-zinc-900 dark:text-zinc-100"
            />
          </Field>
        ...
        <Field label="Buyer address" htmlFor="buyerAddress">
          <textarea
            ...
            className="min-h-24 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100"
          />
        </Field>
      </section>
      ...
      <section className="grid gap-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            className="rounded-full border border-zinc-200 dark:border-zinc-800 px-4 py-2 text-sm font-medium hover:bg-zinc-50 dark:hover:bg-zinc-900"
            onClick={addItem}
          >
            Add row
          </button>
        ...
        {items.map((item, index) => (
          <div key={index} className="grid gap-4 border-b border-zinc-100 dark:border-zinc-800 pb-4 last:border-b-0">
            ...
            <div className="grid gap-3 md:grid-cols-6">
              ...
              <button
                type="button"
                className="h-11 rounded-full border border-zinc-200 dark:border-zinc-800 px-4 text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:bg-zinc-50 dark:hover:bg-zinc-900"
        ...
        <div className="flex items-center justify-between">
          ...
          <Field label="Invoice discount" htmlFor="invoiceDiscount">
            <input
              ...
              className="h-10 w-48 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 text-sm text-zinc-900 dark:text-zinc-100"
            />
          </Field>
        </div>
        {totals ? (
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Add supplier and buyer state to calculate GST.</p>
        )}
      </section>
      ...
      <button
        type="button"
        className="h-11 w-fit rounded-full bg-zinc-900 dark:bg-zinc-100 px-6 text-sm font-medium text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200"
